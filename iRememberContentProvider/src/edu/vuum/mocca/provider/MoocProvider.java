...
public class MoocProvider extends ContentProvider {
    ...
    synchronized private Cursor query(final Uri uri, final String tableName,
    	...
    	// Instrucciones tomadas del ejemplo PlaceBadgeContentProvider.java     
    	SQLiteQueryBuilder qb = new SQLiteQueryBuilder();
    	
    	qb.setTables(tableName);
    	
    	Cursor c = qb.query(this.mDB.getDB(), projection, selection, selectionArgs, null, null, sortOrder);
