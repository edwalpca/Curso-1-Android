...
public class ActivityLoaderActivity extends Activity {
	...
	static protected final String TEXTO = ""; /* By EMA */
	...
	private void startExplicitActivation() {
		...
		Intent intent = new Intent(ActivityLoaderActivity.this,ExplicitlyLoadedActivity.class); /* BY EMA */
		
		
		// TODO - Start an Activity using that intent and the request code defined above
		startActivityForResult(intent,GET_TEXT_REQUEST_CODE);/* BY EMA */
		...
		if (requestCode == GET_TEXT_REQUEST_CODE) { /* BY EMA */
			...
			if (resultCode == RESULT_OK) {/* BY EMA */
				// If so, update the Textview showing the user-entered text.
				 ...
				 String name = resultBundle.getString(TEXTO);
